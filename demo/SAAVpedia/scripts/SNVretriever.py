...
def main(theArgs):
    ...
    theSAAVpedia.setupToSNVRetriever()
    ...
    if theArgs.output:
        ...
        if not os.path.exists(theResultFolder):
            ...
            os.mkdir(theResultFolder)
        theOutputName = theResultFolder + os.sep + datetime.now().strftime('SNVretriever-%Y-%m-%d-%Hh-%Mm-%S.%fs.scf')
...
if __name__ == '__main__':
    ...
    theParser.add_argument('--input', dest='input', help='SNVretriever input file path')
